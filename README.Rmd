...
The predicate function must take a year, month, and day value, and return TRUE if the supplied date is invalid, prompting `sample_date` to generate a new date.
